...
class TestSellInsurance(BaseTest):
    ...
    def test_fillup_insurance_form(self):
        ...
        sell_insurance_page.fill_insurance_form(TestData.insured_lastname,
                                                ...
                                                TestData.insured_address,
                                                TestData.insured_province,
                                                TestData.insured_civil_status,
                                                TestData.insured_occupation,
                                                TestData.insured_place_of_birth,
                                                TestData.insured_sss_tin,
                                                TestData.bene_lastname,
                                                TestData.bene_firstname,
                                                TestData.bene_middlename,
                                                TestData.bene_relationship,
                                                TestData.amount_recieved,
                                                TestData.family_lastname,
                                                TestData.family_firstname,
                                                TestData.family_middlename,
                                                TestData.family_dateofbirth,
                                                TestData.family_relationship,
                                                TestData.reference_client_id)
